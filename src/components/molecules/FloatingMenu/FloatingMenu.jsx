...
export const FloatingMenu = () => {
    const [isMenuFloating, setIsmenuFloating] = useState(true)


    let floatingMenuClass = 'floatingmenu '
    if(!isMenuFloating){
        floatingMenuClass +='menu-toggle'
    }

    let floatIcon = 'fa '
    if(isMenuFloating){
        floatIcon +='fa-caret-down'
    }else{
        floatIcon +='fa-caret-up'
    }

  return (
    <div className={floatingMenuClass}>
        <div className="menu-wrapper">
            <div className="menu-open-close" onClick={()=>{setIsmenuFloating(!isMenuFloating)}}>
                    <div className="open-close-icon">
                        <i className={floatIcon}></i>
                    </div>
            </div>
            <div className="menu-layout">
                ...
                <div className="menu">
                    <div className="menu-box">
                            ...
                            <Link to="/Login" className="menu-single">
                                <div className="menu-icon">
                            ...
                            <Link to="/Event" className="menu-single">
                                <div className="menu-icon">
                            ...
                            <Link to="/Royalcourtnotices" className="menu-single">
                                <div className="menu-icon">
                            ...
                            <Link to="/Speeches" className="menu-single">
                                <div className="menu-icon">
